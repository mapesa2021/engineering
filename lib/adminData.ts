...
const defaultTeamMembers: TeamMember[] = [
  {
    ...
    bio: 'Experienced leader with over 5 years in engineering and business management.',
  ...
  },
  {
    ...
    bio: 'Skilled project manager with expertise in industrial and construction projects.',
    expertise: ['Project Management', 'Construction', 'Industrial Engineering'],
  ...
  },
  {
    ...
    bio: 'Technical expert with deep knowledge in electrical and environmental engineering.',
    expertise: ['Electrical Engineering', 'Environmental Systems', 'Technical Leadership'],

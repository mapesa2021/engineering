      ...
      <div className="container-custom">
        <div className="flex justify-between items-center py-4">
          ...
          <Link href="/" className="flex items-center space-x-3">
            <div className="w-10 h-10 rounded-xl flex items-center justify-center cursor-pointer shadow-lg shadow-oleum-yellow/30 overflow-hidden bg-oleum-yellow">
              <span className="text-oleum-black font-bold text-lg">O</span>
            </div>
        ...
        {isMenuOpen && (
          <div className="md:hidden border-t border-yellow-500/20 py-4 bg-dark-card/50 backdrop-blur-sm">
            <div className="flex flex-col space-y-4">
              ...
              <button className="cta-button flex items-center justify-center space-x-2 mt-4">
                <span className="text-oleum-black">📞</span>
                <span className="text-oleum-black font-semibold">GET QUOTE</span>
              </button>
            </div>
